...
def ask_pdf(request: QueryRequest):
    ...
    # Smart prompt with code detection
    smart_template = """You are a helpful AI assistant specialized in explaining PDF content and programming code.

Use ONLY the context provided to answer the question.

Rules:
- If mode is 'short', give a brief 2-line answer.
- If mode is 'detailed', give a full rich explanation.
- If context contains programming code (like Python, C++, etc.), explain the code beautifully line by line.
- If answer is not found, politely say: "I couldn't find the answer in the document."
...
Answer:"""
    ...
    prompt = PromptTemplate(
        template=smart_template.replace("{mode}", request.mode),
